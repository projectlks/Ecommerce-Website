  ...
  return (
    <footer className=" bg-gradient-to-tr from-blue-gray-900   to-black text-white py-10">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start md:items-center space-y-6 md:space-y-0">
        ...
        <div className="md:w-1/3">
          ...
          <div className="flex space-x-4 text-2xl">
            <a href="https://www.facebook.com/profile.php?id=100041414334073&mibextid=ZbWKwL" className="hover:text-blue-400">
              {/* Facebook Icon */}
              <svg
                stroke="currentColor"
                fill="currentColor"
            ...
            <a href="https://www.instagram.com/mglinkarsoe?igsh=d3FxbWsxdjgzeXNp" className="hover:text-pink-400">
              {/* Instagram Icon */}
              <svg
                stroke="currentColor"
                fill="currentColor"
            ...
            <a href="http://linkedin.com/in/linkar-soe-27a296334" className="hover:text-blue-500">
              {/* LinkedIn Icon */}
              <svg
                stroke="currentColor"
                fill="currentColor"
            ...
            <a   className="hover:text-gray-500" href="mailto:mglinkar08@gmail.com">
              {/* Mail Icon */}
              <svg
                stroke="currentColor"
                fill="currentColor"
      ...
      <div className="text-center mt-6">
        <p className="text-sm">&copy; 2024 Linkar Soe. All rights reserved.</p>
      </div>
    </footer>
  );
};
