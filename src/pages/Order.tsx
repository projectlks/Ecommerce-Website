    ...
    orderData.map((data: any, index: number) => (
      <div key={index} className="mb-20">
        ...
        <div className="w-full px-5 py-3 bg-accent rounded-t-xl flex flex-col justify-center text-background">
          ...
          <h2 className="font-bold text-base md:text-xl mb-2 w-fit">
            Order ID: {data.id}
          </h2>
          <h2 className="font-bold text-base md:text-xl mb-2 tracking-widest">
        ...
        <div className="md:p-6 p-0 bg-[#f1f1f1] w-full border-t-4 border-accent md:flex-row flex-col flex">
          <div className="mb-6 w-[90%] mx-auto md:w-1/2 pb-4">
            ...
            <div className="flex items-center space-x-4">
              <button className="bg-green-500 py-2 px-4 rounded-md text-sm md:text-base">
                Order Confirmed
              </button>
              <button className="bg-red-500 py-2 px-4 rounded-md text-sm md:text-base">
                Cancel Order
              </button>
            </div>
          </div>
          ...
          <div className="w-[90%] xl:w-1/2 md:w-1/2 mx-auto p-4">
            <h1 className="text-xl md:text-2xl font-bold my-3 border-accent py-3 border-b">
              Delivery
            </h1>
